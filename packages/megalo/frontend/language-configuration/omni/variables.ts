...
export const VARIABLE_SCOPE_NAMES = [
  "global",
  "team",
  "player",
  "object",
...
export const isVariableScopeName = (
  value: string
): value is VariableScopeName =>
  (VARIABLE_SCOPE_NAMES as readonly string[]).includes(value);

export const isNumericVariableType = (
  value: string
): value is "timer" | "number" => value === "timer" || value === "number";
...
export const variableScopeFromName = (
