...
export type BuiltInNonNumericOverrideOption =
  (typeof BUILT_IN_NON_NUMERIC_OVERRIDE_OPTIONS)[number];
...
export const isBuiltInNonNumericOverrideOption = (
  value: string
): value is BuiltInNonNumericOverrideOption =>
