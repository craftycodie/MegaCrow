...
Modifies an object's current health with a [math operation](/language/enums/math-operations). 100 is 100% health.
...
- [object_adjust_shield](/language/actions/object-adjust-shield)
