...
export class VersionConfiguration49 extends VersionConfiguration {
  ...
  private static readonly VARIABLE_LIMITS: VariableLimits = {
    ...
    [VariableScope.Team]: {
      [VariableType.Number]: 3,
      [VariableType.Timer]: 3,
      [VariableType.Team]: 3,
  ...
  public get objectListNames(): readonly string[] {
    return VersionConfiguration49.OBJECT_LIST_NAMES;
  }

  public get pregameActions(): readonly ActionType[] {
    return VersionConfiguration49.PREGAME_ACTIONS;
  }
}
