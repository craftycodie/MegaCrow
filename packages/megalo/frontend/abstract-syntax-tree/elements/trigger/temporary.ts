...
export const TEMPORARY_STORAGE_NAMES = ["number", "object", "team", "player"] as const;
export type TemporaryStorageName = (typeof TEMPORARY_STORAGE_NAMES)[number];

export const isTemporaryStorageName = (value: string): value is TemporaryStorageName =>
...
export const parseTemporary = (
    ...
    const initial = parseIfOperand(ctx, name?.location ?? temporaryToken.location);
