...
[数学演算](/ja/language/enums/math-operations) を使って、オブジェクトの現在のシールドを変更します。100 はシールド 100% です。
...
- [object_adjust_health](/ja/language/actions/object-adjust-health)
