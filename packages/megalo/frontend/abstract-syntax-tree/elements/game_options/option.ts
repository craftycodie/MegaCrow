...
const parseUserDefinedOptionValue = (
    ...
    return {
        ...
        name,
        description,
        location: locationSpan(anchor.location, stringLiteralOrReferenceLocation(description)),
    };
};
...
export const parseUserDefinedOption = (
    ...
    return {
        kind: ranged ? GameOptionEntryKind.RANGED_OPTION : GameOptionEntryKind.OPTION,
        modifiers,
        name,
        displayName,
        description,
...
export const optionParser = (
    ...
    keywordToken: Token,
    modifiers: GameOptionModifiers,
): UserDefinedOptionNode => parseUserDefinedOption(ctx, keywordToken, modifiers, false);
